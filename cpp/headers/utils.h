...
public:
    bool sameSide(Point a, Point b); //Vérifie si les points a et b sont dans le même demi plan formé par la droite définie à partir de l'arete
};
...
struct Face {
    Edge E1, E2, E3;
    Point P1, P2, P3; //Le point P1 est opposé à l'arête E1, etc.
    
public:
    bool isInFace(Point p); //Dit si le point est dans la face (wesh si on s'est pris un pain dans la gueule)
